...
public class AutocompletionlTextField extends TextField {
    ...
    public static TextFlow buildTextFlow(String text, String filter) {
        ...
        //textFilter.setUnderline(true);
        //textFilter.setSmooth(true);
        textAfter.setFill(Color.BLACK);
        textAfter.setFont(Font.font("Verdana",FontWeight.SEMI_BOLD,12));
        textFilter.setFill(Color.BLUE);
        textFilter.setFont(Font.font("Verdana", FontWeight.BOLD, 15));
